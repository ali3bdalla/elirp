...
class Version200 extends Listener
{
        ...
        foreach ($contacts as $vendor_id => $contact_id) {
            ...
            DB::table('mediables')
                ...
                ->update([
                    ...
                    'mediable_type' => 'App\Models\Contact',
                ]);
            ...
            if ($has_double_entry_ledger) {
                DB::table('double_entry_ledger')
                    ...
                    ->update([
                        ...
                        'ledgerable_type' => 'App\Models\Transaction',
                    ]);
            }
        }
        ...
        foreach ($revenues as $revenue) {
            ...
            DB::table('recurring')
                ...
                ->update([
                    ...
                    'recurable_type' => 'App\Models\Transaction',
                ]);
            ...
            DB::table('mediables')
                ...
                ->update([
                    ...
                    'mediable_type' => 'App\Models\Transaction',
                ]);
    ...
    public function deleteOldFiles()
    {
        $files = [
            ...
            'css/app.css',
            'css/bootstrap3-print-fix.css',
            'css/bootstrap-fancyfile.css',
            'css/countdown.css',
            ...
            'js/bootstrap-fancyfile.js',
            'js/jquery/jquery.maskMoney.js',
