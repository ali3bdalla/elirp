...
class Version210 extends Listener
{
        ...
        foreach ($tables as $table => $column) {
            ...
            $classes = [
                'invoices'               => [
                    ...
                    'replacement'  => 'App\Models\Document',
                ],
                'invoice_items'          => [
                    'sort_key'     => 'invoice',
                    'table_suffix' => '_items',
                    ...
                    'replacement'  => 'App\Models\DocumentItem',
                ],
                'invoice_item_taxes'     => [
                    'sort_key'     => 'invoice',
                    ...
                    'replacement'  => 'App\Models\DocumentItemTax',
                ],
                'invoice_totals'         => [
                    'sort_key'     => 'invoice',
                    ...
                    'replacement'  => 'App\Models\DocumentTotal',
                ],
                'invoice_histories'      => [
                    'sort_key'     => 'invoice',
                    ...
                    'replacement'  => 'App\Models\DocumentHistory',
                ],
                'bills'                  => [
                    'sort_key'     => 'bill',
                    'table_suffix' => 's',
    ...
    {
        $income_category = Category::income()->enabledFactoryState()->first();
        $expense_category = Category::expense()->enabledFactoryState()->first();
    ...
    public function deleteOldFiles()
    {
        $files = [
            ...
            'public/0.js',
            'public/38.js',
            'js/purchases/bills.js',
            'js/sales/invoices.js',
