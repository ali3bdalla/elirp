<template>
  <div class="d-flex flex-column flex-root">
    ...
    <div class="d-flex flex-center flex-row-fluid bgi-size-cover bgi-position-top bgi-no-repeat" style="height: 100%;min-height: 100%;position: absolute;width: 100%;background-image: url('assets/media/bg/bg-3.jpg');">
        ...
        <div class="login-signin">
          ...
          <div class="form">
            <div class="form-group mb-5">
              <input v-model="form.email" class="form-control h-auto form-control-solid py-4 px-8" type="text"
                     placeholder="Email"
                      name="username" autocomplete="off" />
            </div>
            <div class="form-group mb-5">
              <input v-model="form.password" class="form-control h-auto form-control-solid py-4 px-8" type="password"
            ...
            <button @click="submit" class="btn btn-primary font-weight-bold px-9 py-4 my-3   btn-block">Sign
              In</button>
          </div>
          <div class="mt-10">
